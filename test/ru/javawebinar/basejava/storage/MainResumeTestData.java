...
import ru.javawebinar.basejava.model.Epoch;
...
public class MainResumeTestData {
    public static void main(String[] args) {
        ...
        r1.setContact(ContactType.PHONENR, "+7(921) 855-0482");
        ...
        r1.setSection(SectionType.EXPERIENCE,
                new OrganisationListSection(new ArrayList<>(Arrays.asList(
                        new Organisation("Java Online Projects", "http://javaops.ru/",
                                new ArrayList<Epoch>(Collections.singletonList(new Epoch(LocalDate.of(2013, 10, 1), LocalDate.now(), "Автор проекта.",
                                        "Создание, организация и проведение Java онлайн проектов и стажировок")))),
                        new Organisation("Wrike", "https://www.wrike.com/",
                                new ArrayList<Epoch>(Collections.singletonList(new Epoch(LocalDate.of(2014, 10, 1), LocalDate.of(2016, 1, 1), "\tСтарший разработчик (backend)",
                                        "Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API, Maven, Spring, MyBatis, Guava, Vaadin, PostgreSQL, Redis). Двухфакторная аутентификация, авторизация по OAuth1, OAuth2, JWT SSO.")))),
                        new Organisation("RIT Center", null,
                                new ArrayList<Epoch>(Collections.singletonList(new Epoch(LocalDate.of(2012, 4, 1), LocalDate.of(2014, 10, 1), "Java архитектор",
                        ...
                        new Organisation("Luxoft (Deutsche Bank)", "http://www.luxoft.ru/",
                                new ArrayList<Epoch>(Collections.singletonList(new Epoch(LocalDate.of(2010, 12, 1), LocalDate.of(2012, 4, 1), "Ведущий программист",
                                        "Участие в проекте Deutsche Bank CRM (WebLogic, Hibernate, Spring, Spring MVC, SmartGWT, GWT, Jasper, Oracle). Реализация клиентской и серверной части CRM. Реализация RIA-приложения для администрирования, мониторинга и анализа результатов в области алгоритмического трейдинга. JPA, Spring, Spring-MVC, GWT, ExtGWT (GXT), Highstock, Commet, HTML5.")))),
                        new Organisation("Yota", "https://www.yota.ru/",
                                new ArrayList<Epoch>(Collections.singletonList(new Epoch(LocalDate.of(2008, 6, 1), LocalDate.of(2010, 12, 1), "Ведущий специалист",
                                        "Дизайн и имплементация Java EE фреймворка для отдела \"Платежные Системы\" (GlassFish v2.1, v3, OC4J, EJB3, JAX-WS RI 2.1, Servlet 2.4, JSP, JMX, JMS, Maven2). Реализация администрирования, статистики и мониторинга фреймворка. Разработка online JMX клиента (Python/ Jython, Django, ExtJS)")))),
                        new Organisation("Enkata", "http://enkata.com/",
                                new ArrayList<Epoch>(Collections.singletonList(new Epoch(LocalDate.of(2007, 3, 1), LocalDate.of(2008, 6, 1), "Разработчик ПО",
                                        "Реализация клиентской (Eclipse RCP) и серверной (JBoss 4.2, Hibernate 3.0, Tomcat, JMS) частей кластерного J2EE приложения (OLAP, Data mining).")))),
                        new Organisation("Siemens AG", "https://www.siemens.com/ru/ru/home.html",
                                new ArrayList<Epoch>(Collections.singletonList(new Epoch(LocalDate.of(2005, 1, 1), LocalDate.of(2007, 2, 1), "Разработчик ПО",
                                        "Разработка информационной модели, проектирование интерфейсов, реализация и отладка ПО на мобильной IN платформе Siemens @vantage (Java, Unix).")))),
                        new Organisation("Alcatel", "",
                                new ArrayList<Epoch>(Collections.singletonList(new Epoch(LocalDate.of(1997, 9, 1), LocalDate.of(2005, 1, 1), "Инженер по аппаратному и программному тестированию",
        ...
        r1.setSection(SectionType.EDUCATION,
                new OrganisationListSection(new ArrayList<Organisation>(Arrays.asList(
                        new Organisation("Coursera", "https://www.coursera.org/course/progfun",
                                new ArrayList<Epoch>(Collections.singletonList(new Epoch(LocalDate.of(2013, 3, 1), LocalDate.of(2013, 5, 1), "\"Functional Programming Principles in Scala\" by Martin Odersky",
                                        null)))),
                        new Organisation("Luxoft", "http://www.luxoft-training.ru/training/catalog/course.html?ID=22366",
                                new ArrayList<Epoch>(Collections.singletonList(new Epoch(LocalDate.of(2011, 3, 1), LocalDate.of(2011, 4, 1), "Курс \"Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.\"",
                                        null)))),
                        new Organisation("Siemens AG", "http://www.siemens.ru/",
                                new ArrayList<Epoch>(Collections.singletonList(new Epoch(LocalDate.of(2005, 1, 1), LocalDate.of(2005, 4, 1), "3 месяца обучения мобильным IN сетям (Берлин)",
                                        null)))),
                        new Organisation("Alcatel", "http://www.alcatel.ru/",
                                new ArrayList<Epoch>(Collections.singletonList(new Epoch(LocalDate.of(1997, 9, 01), LocalDate.of(1998, 3, 1), "6 месяцев обучения цифровым телефонным сетям (Москва)",
                                        null)))),
                        new Organisation("Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики", "",
                                new ArrayList<Epoch>(Arrays.asList(new Epoch(LocalDate.of(1993, 9, 1), LocalDate.of(1996, 7, 1), "Аспирантура (программист С, С++)",
                                        null), new Epoch(LocalDate.of(1987, 9, 1), LocalDate.of(1993, 7, 1), "Инженер (программист Fortran, C)",
                                        null)))),
                        new Organisation("Заочная физико-техническая школа при МФТИ", "",
                                new ArrayList<Epoch>(Collections.singletonList(new Epoch(LocalDate.of(1984, 9, 1), LocalDate.of(1987, 6, 1), "Закончил с отличием",
                                        null))))
                                ))));
    }
}
